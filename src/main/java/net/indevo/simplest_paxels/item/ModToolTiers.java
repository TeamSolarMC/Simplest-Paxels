...
public class ModToolTiers {
    public static final Tier WOOD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "planks"), List.of(Tiers.WOOD), List.of());
    ...
    public static final Tier STONE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "stone"), List.of(Tiers.STONE), List.of());
    ...
    public static final Tier IRON = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "iron_ingot"), List.of(Tiers.IRON), List.of());
    ...
    public static final Tier GOLD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "gold_ingot"), List.of(Tiers.GOLD), List.of());
    ...
    public static final Tier DIAMOND = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "diamond"), List.of(Tiers.DIAMOND), List.of());
    ...
    public static final Tier NETHERITE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(SimplestPaxels.MOD_ID, "netherite_ingot"), List.of(Tiers.NETHERITE), List.of());
